...
<body>
	...
	<form action="user" method="post">
		...
		<table cellpadding="5">
			...
			<tr>
				<td>密码:</td>
				<td><input name="pwd" type="password" class="easyui-validatebox textbox" data-options="required:true,validType:'email'" missingMessage="密码必填"></td>
			</tr>
			<tr>
				<td>性别:</td>
				<td>
			...
			<tr>
				<td>出生年月:</td>
				<td><input name="birth" class="easyui-validatebox textbox" value=""></td>
			</tr>
			<tr>
